  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: bottomPad + 28 }]}>
        ...
        <View style={[styles.bigRow, { backgroundColor: colors.card, borderColor: colors.border, borderRadius: 18 }]}>
          <Feather name="globe" size={28} color={colors.primary} />
          <View style={styles.flex1}>
            <Text style={[styles.rowTitle, { color: colors.foreground }]}>Dialect & Singlish AI</Text>
            <Text style={[styles.rowDesc, { color: colors.mutedForeground }]}>Active — understands Singlish, Hokkien, Cantonese & mixed languages</Text>
          </View>
